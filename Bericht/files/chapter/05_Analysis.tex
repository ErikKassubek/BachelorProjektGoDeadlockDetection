...
100 Routinene mir zwei Locks ($100\times 2)$ und zum Schluss 100 Routinen 
...
\begin{table}[H]
    ...
    \makecell{Deadlock-Go\\ohne periodische} &
      \makecell{0.070+0.002\\0.072} &
      \makecell{0.740 + 41.325\\42.065} &
      \makecell{2.175 + 0.260\\2.535} & \makecell{41.532 + 113 687.142\\113 728.674}
       \\ \hline
    \makecell{Deadlock-Go\\mit periodische} &
      \makecell{0.072+0.002\\0.079} &
      \begin{tabular}[c]{@{}l@{}}\makecell{0.804+41.585\\42.368}\\ \end{tabular} &
      \makecell{2.178 + 0.263\\2.441} &
      \makecell{60.509 + 106 799.742\\106 860.251} \\ \hline
    Sasha-s       & 0.062          & 12.622         & 11.541         & 507.628         \\ \hline
    \end{tabular}
    \caption{Laufzeiten der einzelnen Programm für bzw. ohne die Detektoren}
    \label{Tab:Time}
\end{table}
Für die Detektion mit Deadlock-Go werden sowohl die Laufzeit des 
eigentlichen Programms sowie die Laufzeit der abschließenden Detektion und 
die Gesamtzeit angegeben. 
Graphisch gibt sich folgendes Bild:
